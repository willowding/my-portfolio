...
const seedImages = [
  // 3 待审
  { f: "1.jpg", filename: "01_封面.jpg", uploader: "Designer-Avery", status: "pending", h: 2.0 },
  ...
  // 2 已通过
  {
    ...
    comments: [{ user: "PM-Cindy", text: "构图、色彩 OK，通过。", tags: [], time: ago(60 * 60 * 1000), action: "approved" }],
  },
  {
    f: "5.jpg", filename: "05.jpg", uploader: "Designer-Ryan", status: "approved",
    reviewed_by: "PM-Cindy", h: 4,
    comments: [{ user: "PM-Cindy", text: "通过", tags: [], time: ago(45 * 60 * 1000), action: "approved" }],
  },
  // 2 已打回
  {
    f: "6.jpg", filename: "06.jpg", uploader: "Designer-Avery", status: "rejected",
    reviewed_by: "PM-Cindy", reject_reason: "主角描边过粗，整体偏离系列风格",
    tags: ["有描边", "风格问题"], h: 6,
    comments: [{ user: "PM-Cindy", text: "主角描边过粗，整体偏离系列风格", tags: ["有描边", "风格问题"], time: ago(30 * 60 * 1000), action: "rejected" }],
  },
  {
    f: "7.jpg", filename: "07.jpg", uploader: "Designer-Ryan", status: "rejected",
    reviewed_by: "PM-Cindy", reject_reason: "动作与剧情不符，第二格人物应在跑而不是站立",
    tags: ["剧情问题"], h: 6,
    comments: [{ user: "PM-Cindy", text: "动作与剧情不符，第二格人物应在跑而不是站立", tags: ["剧情问题"], time: ago(20 * 60 * 1000), action: "rejected" }],
  },
  // 2 已认领（打回后被认领）
  {
    f: "8.jpg", filename: "08.jpg", uploader: "Designer-Avery", status: "rejected",
    reviewed_by: "PM-Cindy", reject_reason: "色彩对比度不够，主体不突出",
    tags: ["色彩/文字问题"], claimed_by: "Designer-Avery", claimed_at: ago(10 * 60 * 1000), h: 7,
    comments: [
      { user: "PM-Cindy", text: "色彩对比度不够，主体不突出", tags: ["色彩/文字问题"], time: ago(40 * 60 * 1000), action: "rejected" },
      { user: "Designer-Avery", text: "我来改！", type: "claim", time: ago(10 * 60 * 1000) },
    ],
  },
  {
    f: "9.jpg", filename: "09_封底.jpg", uploader: "Designer-Ryan", status: "rejected",
    reviewed_by: "PM-Cindy", reject_reason: "封底缺少品牌 logo",
    tags: ["形象/场景问题"], claimed_by: "Designer-Ryan", claimed_at: ago(5 * 60 * 1000), h: 8,
    comments: [
      { user: "PM-Cindy", text: "封底缺少品牌 logo", tags: ["形象/场景问题"], time: ago(35 * 60 * 1000), action: "rejected" },
      { user: "Designer-Ryan", text: "我来改！", type: "claim", time: ago(5 * 60 * 1000) },
    ],
  },
];
